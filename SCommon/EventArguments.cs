...
namespace SCommon
{
    ...
    public class KickUserEventArgs : EventArgs
    {
        public string To { get; internal set; }
        public string From { get; internal set; }
        public string Message { get; internal set; }

        public KickUserEventArgs(string to, string from, string message)
        {
            this.To = to;
            this.From = from;
            this.Message = message;
    ...
    public class ChannelEmoteEventArgs : EventArgs
    {
        public string Channel { get; internal set; }
        public string From { get; internal set; }
        public string Message { get; internal set; }

        public ChannelEmoteEventArgs(string channel, string from, string message)
        {
            this.Channel = channel;
            this.From = from;
            this.Message = message;
